...
function setup() 
{
  ...
  star_display.addAnimation('star1',one_star)
  star_display.addAnimation('star2',two_star)
...
function draw() 
{
 ...
 star1.visible = false
 star_display.changeAnimation('star1',one_star)
  }

  if(collide(fruit,star2,20)==true){
    star2.visible = false
    star_display.changeAnimation('star2',two_star)
     }
